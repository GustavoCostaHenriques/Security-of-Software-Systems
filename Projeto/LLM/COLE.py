...
This module is consuming the Redis-list created by the COLE_Feed_Q Module,
...
..note:: Module COLE_Something_Q and COLE_Something are closely bound, always put
...
*Need the COLE_Feed_Q Module running to be able to work properly.
